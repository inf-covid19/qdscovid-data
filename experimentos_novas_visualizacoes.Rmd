...
```{r}
sum_matrix = data.matrix(subset(sum_data[, !str_detect(names(sum_data), "dom_")], select = -c(municipioIBGE, n, population)))

sum_matrix = sum_matrix / sum_data$n
sum_matrix_pop = sum_matrix / sum_data$population
