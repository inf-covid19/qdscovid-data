...
for (estado in levels(dados$estadoIBGE)) {
   write.table(dados[dados$estadoIBGE == estado,], file = paste("output/qdscovid_registers/qdscovid_registers_", estado, ".csv", sep = ""), quote = FALSE, row.names = FALSE, sep = ";", eol = "\r")
}
...
for (estado in levels(dados$estadoIBGE)) {
   write.table(dados[dados$estadoIBGE == estado,], file = paste("output/qdscovid_symptoms/qdscovid_symptoms_", estado, ".csv", sep = ""), quote = FALSE, row.names = FALSE, sep = ";", eol = "\r")
}
...
for (estado in levels(dados$estadoIBGE)) {
   write.table(dados[dados$estadoIBGE == estado,], file = paste("output/qdscovid_conditions/qdscovid_conditions_", estado, ".csv", sep = ""), quote = FALSE, row.names = FALSE, sep = ";", eol = "\r")
}
